...
export default function Privacy() {
  return (
    <div className="w-full min-h-screen bg-background pt-32 pb-20 px-6 md:px-12 lg:px-24">
      ...
      <Helmet>
        <title>Privacy Policy | Habit Æffect</title>
        <meta
          name="description"
          content="Review Habit Æffect’s privacy policy outlining how personal information is collected, used, and protected."
        />
      </Helmet>
      ...
      <div className="max-w-5xl mx-auto text-gray-900 font-medium text-lg leading-relaxed space-y-6">
        ...
        <p>
          This Privacy Policy explains how Habit Æffect collects, uses, and
          protects your information. The content below is a placeholder and will be
        ...
        <p>
          ...
          Additional optional data may be collected through scheduling platforms,
        ...
        <p>
          ...
          Calendly, Google Forms, and Stripe maintain their own security policies
          and procedures.
        </p>
        ...
        <p className="mt-8">
          This placeholder version will be replaced with a full privacy policy
          drafted for the official Habit Æffect platform.
        </p>
