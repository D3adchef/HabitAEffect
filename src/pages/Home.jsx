...
export default function Home() {
  return (
    <>
      <Helmet>
        <title>Habit Æffect | Sustainable Habit Change That Fits Real Life</title>
        <meta
          name="description"
          content="Habit Æffect offers neurodivergent-affirming habit coaching focused on clarity, compassion, and sustainable systems. Build habits that fit how your brain actually works."
        />
      </Helmet>
      ...
      <div className="w-full min-h-screen bg-background px-6 md:px-12 lg:px-24 py-12">
        ...
        <div className="max-w-4xl mx-auto mt-12 border-t border-blue-900 pt-6 text-gray-900 font-medium space-y-4">
          <h2 className="text-2xl md:text-3xl font-bold text-orange text-center underline">
