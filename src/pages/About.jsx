  ...
  return (
    <div className="w-full min-h-screen bg-background pt-32 pb-20 px-6 md:px-12 lg:px-24">
      ...
      <div className="max-w-4xl mx-auto text-blue-900 text-lg leading-relaxed space-y-6">
        ...
        <p>
          This program blends behavioral science, structured guidance, and
          personalized support to help clients identify how their habits formed,
          why certain behaviors repeat, and how to build new patterns that
          actually stick.
        </p>
